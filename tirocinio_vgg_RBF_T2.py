...
IMG_SIZE = 224
NUM_FEATURES = 512
num_frame = 6320 #numero di frame presenti nei video
groups = []
num_video=0
groups_video = []
...
with tf.device('/cpu:0'): #forza l'uso della cpu in keras
    ...
    def build_feature_extractor_vggface():
        feature_extractor = VGGFace( #model='vgg16', weights='vggface' by default
            include_top=False,
    ...
    feature_extractor = build_feature_extractor_vggface()
